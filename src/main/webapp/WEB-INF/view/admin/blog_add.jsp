...
<div class="tpl-page-container tpl-page-header-fixed">
    <!--菜单导航-->
    <jsp:include page="comm/menu.jsp"/>
            ...
            <div class="tpl-block">
                ...
                <div class="am-g">
                    <div class="tpl-form-body tpl-form-line">
                        <form class="am-form tpl-form-line-form" action="${pageContext.request.contextPath}/admin/article/add/do" method="post" enctype="multipart/form-data">
                            ...
                            <div class="am-form-group">
                                <label for="catalogId" class="am-u-sm-3 am-form-label">栏目 <span class="tpl-form-line-small-title">Author</span></label>
                                <div class="am-u-sm-9">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="keywords" name="keywords" placeholder="输入关键字">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-intro" class="am-u-sm-3 am-form-label">文章简介</label>
                                <div class="am-u-sm-9">
                                    <textarea class="" rows="7"  id="desci"  name="desci"  id="user-intro" placeholder="请输入文章简介"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    <button type="submit" class="am-btn am-btn-primary tpl-btn-bg-color-success ">发表博客</button>
